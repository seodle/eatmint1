---
title: "EATMINT1 experiment - Wilcoxon test"
author: "Sunny Avry"
date: "July 17th, 2019"
output:
...
```{r}
#("C:/Users/Utilisateur/Google Drive/1-Thesis/4-EATMINT1/Analyses/Analyses/Analyse_taux_utilisation_actes/Analyse 4 - Wilcoxon test") #HP
setwd("C:/Users/Sunny/Google Drive/1-Thesis/4-EATMINT1/Analyses/Analyses/Analyse_taux_utilisation_actes/Analyse 4 - Wilcoxon test") #Surface
...
max.window.size <- 15 #size of the window = number of collaborative acts per window : the size of the window is shorter when another emotion is encountered before max.window.size is reached or the end of the collaborative acts
```
...
```{r}
#Find cases available (cases that have shared the emotion)
...
```{r}
#Compute the relative use for the emotion interested

#select the subset of collaborative acts for a given participant. We need to select for the emotion interested, the (max.windows.size) collaborative acts of the other's partner from the same dyad
...
#compute the real-time use for every collaborative process
  ...
  x <- x/(length(interested.collaborative.processes.table))
...
for (p in participants_eat_interested_P02)
{
  ...
  #compute the relative use for every collaborative process
...
```{r}
#Compute the relative use when no emotion interested in the eat condition
...
```{r}
#Compute the relative use for the emotion focused

#select the subset of collaborative processes for a given participant. We need to select for the emotion delighted, the (max.windows.size) collaborative processes of the other's partner from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(focused.collaborative.processes.table))
...
```{r}
#Compute the relative use when no emotion focused
...
```{r}
#Compute the relative use for the emotion delighted
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(delighted.collaborative.processes.table))
...
```{r}
#Compute the relative use when no emotion delighted
...
```{r}
#Compute the relative use for the emotion satisfied

#select the subset of collaborative processes for a given participant. We need to select for the emotion satisfied, the (max.windows.size) collaborative processes of the other's partner from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(satisfied.collaborative.processes.table))
...
```{r}
#Compute the relative use for the emotion amused

#select the subset of collaborative processes for a given participant. We need to select for the emotion amused, the (max.windows.size) collaborative processes of the other's partner from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(amused.collaborative.processes.table))
...
```{r}
#Compute the relative use for the emotion relaxed

#select the subset of collaborative processes for a given participant. We need to select for the emotion relaxed, the (max.windows.size) collaborative processes of the other's partner from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(relaxed.collaborative.processes.table))
...
```{r}
#Compute the relative use for the emotion confident

#select the subset of collaborative processes for a given participant. We need to select for the emotion confident, the (max.windows.size) collaborative processes of the other's participant from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(confident.collaborative.processes.table))
...
```{r}
#Compute the relative use for the emotion confused

#select the subset of collaborative processes for a given participant. We need to select for the emotion confused, the (max.windows.size) collaborative processes of the other's participant from the same dyad
...
#compute the relative use for every collaborative process
  ...
  x <- x/(length(confused.collaborative.processes.table))
...
#Surface
write.xlsx(emotions.results, "C:/Users/Sunny/Google Drive/1-Thesis/4-EATMINT1/Analyses/Analyses/Analyse_taux_utilisation_actes/Analyse 4 - Wilcoxon test/results15.xlsx") 

#write.xlsx(emotions.results, "C:/Users/Utilisateur/Google Drive/1-Thesis/4-EATMINT1/Analyses/Analyses/Analyse_taux_utilisation_actes/Analyse 4 - Wilcoxon test/results5.xlsx") #HP
