...
for (p in participants_eat_interested_P02)
{
  ...
  dtest <- c(2,3,5,6,7,8,4,5,4,3,4,5)
  
  max.window.size <- 15

  data.kept[c(1:((n%%max.window.size)*max.window.size)),]
  
  length(data.kept[c(1:((n%%max.window.size)*max.window.size)),]$participant)
  
  
  
  
  print(length(data.kept$participant))
